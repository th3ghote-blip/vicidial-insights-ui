...
import type { Lead, AttemptROI, CallbackStats } from "@/lib/api";
...
export default function LeadsTab({
  lang, leads, range, rangeLabel,
  attemptROI, callbackStats,
}: {
  lang: Lang; leads: Lead[]; range?: number; rangeLabel?: "today" | number | "custom";
